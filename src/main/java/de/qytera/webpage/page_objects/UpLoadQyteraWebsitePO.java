...
public class UpLoadQyteraWebsitePO extends TestContext {
        ...
        //public static final By dropdown = By.xpath("//button[@type='projectSelector']");
        ...
        Assert.assertEquals(firstoption, "Qytera Website");
